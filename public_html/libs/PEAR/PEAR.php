...
if (!defined('PATH_SEPARATOR')) {
	if (OS_WINDOWS) define('PATH_SEPARATOR', ';');
...
function _PEAR_call_destructors() {
	...
	if (is_array($_PEAR_destructor_object_list) && sizeof($_PEAR_destructor_object_list)) {
		...
		if (PEAR::getStaticProperty('PEAR', 'destructlifo')) $_PEAR_destructor_object_list = array_reverse($_PEAR_destructor_object_list);
