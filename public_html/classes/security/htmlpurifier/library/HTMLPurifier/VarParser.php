...
class HTMLPurifier_VarParser
{
	...
	final public function parse($var, $type, $allow_null = false) {
		if (is_string($type)) {
			if (!isset(HTMLPurifier_VarParser::$types[$type])) throw new HTMLPurifier_VarParserException("Invalid type '$type'");
			else $type = HTMLPurifier_VarParser::$types[$type];
		}
	...
	static public function getTypeName($type) {
		static $lookup;
		if (!$lookup) $lookup = array_flip(HTMLPurifier_VarParser::$types);
