...
class Purifier
{
	...
	public function getInstance() {
		if(!isset($GLOBALS['__PURIFIER_INSTANCE__'])) $GLOBALS['__PURIFIER_INSTANCE__'] = new Purifier();
	...
	private function _setDefinition(&$content) {
		...
		if(is_array($widgetAttrs)) {
			foreach($widgetAttrs AS $k => $v) $this->_def->addAttribute('img', $v, 'CDATA');
		}
	}
