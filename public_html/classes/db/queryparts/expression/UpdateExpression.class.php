...
class UpdateExpression extends Expression
{
	...
	function getExpression($with_value = true) {
		if($with_value) return $this->getExpressionWithValue();
	...
	function getExpressionWithValue() {
		...
		if(isset($operation)) return "$this->column_name = $this->column_name $operation $value";
	...
	function getArguments() {
		if($this->argument) return array($this->argument);
		else return array();
	}
}
