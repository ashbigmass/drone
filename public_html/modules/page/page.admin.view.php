...
class pageAdminView extends page
{
	...
	function dispPageAdminMobileContent() {
		if($this->module_info->page_type == 'OUTSIDE') return $this->stop(-1, 'msg_invalid_request');
	...
	function dispPageAdminMobileContentModify() {
		Context::set('module_info', $this->module_info);
		if ($this->module_info->page_type == 'WIDGET') $this->_setWidgetTypeContentModify(true);
		else if ($this->module_info->page_type == 'ARTICLE') $this->_setArticleTypeContentModify(true);
	}
