...
{
	var $services = array('Naver' => 'http://syndication.openapi.naver.com/ping/',);
	var $statuses = array('Naver' => 'http://syndication.openapi.naver.com/status/?site=%s',);
	...
	function checkOpenSSLSupport() {
		if(!in_array('ssl', stream_get_transports())) return FALSE;
		return TRUE;
	}
}
