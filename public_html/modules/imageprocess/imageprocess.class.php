...
class imageprocess extends ModuleObject
{
	...
	function moduleUpdate() {
		...
		if (!extension_loaded('exif') && $oldconfig->rotate_use == 'Y') $ipConfig->rotate_use = 'N';
		...
		if(!$oModuleModel->getTrigger('document.moveDocumentModule','imageprocess', 'controller', 'triggerMoveDocument', 'before'))
			$oModuleController->insertTrigger('document.moveDocumentModule','imageprocess', 'controller', 'triggerMoveDocument', 'before');
