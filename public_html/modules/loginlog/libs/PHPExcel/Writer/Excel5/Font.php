...
class PHPExcel_Writer_Excel5_Font
{
	...
	public function writeFont() {
		...
		if ($this->_font->getSuperScript()) $sss = 1;
		else if ($this->_font->getSubScript()) $sss = 2;
		else $sss = 0;
		$bFamily = 0;
		...
		$reserved = 0x00;
		$grbit = 0x00;
		if ($this->_font->getItalic()) $grbit |= 0x02;
		if ($this->_font->getStrikethrough()) $grbit |= 0x08;
		if ($font_outline) $grbit |= 0x10;
		if ($font_shadow) $grbit |= 0x20;
		$data = pack("vvvvvCCCC",
