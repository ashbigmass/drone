<?php
if (!defined('PCLZIP_TEMPORARY_DIR')) define('PCLZIP_TEMPORARY_DIR', PHPExcel_Shared_File::sys_get_temp_dir());
...
class PHPExcel_Shared_ZipArchive
{
	...
	public function addFromString($localname, $contents) {
		...
		if ($res == 0) throw new Exception("Error zipping files : " . $this->_zip->errorInfo(true));
