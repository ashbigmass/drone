...
abstract class PHPExcel_CachedObjectStorage_CacheBase
{
	...
	protected function _getUniqueID() {
		if (function_exists('posix_getpid')) $baseUnique = posix_getpid();
		else $baseUnique = mt_rand();
		return uniqid($baseUnique,true);
	}

	public function copyCellCollection(PHPExcel_Worksheet $parent) {
		$this->_parent = $parent;
		if (($this->_currentObject !== NULL) && (is_object($this->_currentObject))) $this->_currentObject->attach($parent);
	}
